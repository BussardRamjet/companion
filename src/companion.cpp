...
public:
        ...
        ImDrawList& draw_list)
    {
        ...
        if (!m_visited)
        {
            if (m_roomState[a_Dragon] == rs_Unknown &&
            ...
            {
                int lineCounter = 
                    (int32)(is_state_visible(m_roomState[a_Dragon])) +
                    (int32)(is_state_visible(m_roomState[a_Arrow])) +
                    (int32)(is_state_visible(m_roomState[a_Pit]));
